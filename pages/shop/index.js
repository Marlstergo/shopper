  ...
  return (
    ...
    <div className="text-gray-700 mt-20">
      ...
      <div className="min-h-[80vh] flex flex-col space-y-5">
        <div>
          <div>
            <h2 className="cursor-pointer text-3xl my-3 font-semibold">Mens's Clothing</h2>
          </div>
        ...
        <div className="">
          <div>
            ...
            className="text-3xl my-3 cursor-pointer font-semibold">Jewelery</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div className="">
          <div>
            ...
            className="text-3xl my-3 font-semibold cursor-pointer">Women's Clothing</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div className="">
          <div>
            ...
            className="text-3xl my-3 font-semibold cursor-pointer">Electronics</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div className="">
          <div>
            ...
            className="text-3xl my-3 font-semibold cursor-pointer">Misc</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
            {products
