      ...
      <div>
        <div>
          ...
          <div className="flex flex-col md:flex-row h-[400px]">
            ...
            <div className="md:w-1/2 flex flex-col items-start space-y-6 text-xl justify-center text-left">
              <h3 className="text-base">{prodItem.title}</h3>
              <p className="text-sm">{prodItem.description}</p>
              <p className="text-lg">${prodItem.price}</p>
            </div>
          </div>
        </div>
      </div>
