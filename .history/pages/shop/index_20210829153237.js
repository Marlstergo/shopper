  ...
  return (
    <div className="text-gray-700">
      ...
      <div className="min-h-[80vh] flex flex-col space-y-5">
        <div>
          <div>
            <h2 className="text-3xl my-3">Mens's Clothing</h2>
          </div>
        ...
        <div className="">
          <div>
            <h2 className="text-3xl my-3">Jewelery</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div className="">
          <div>
            <h2 className="text-3xl my-3">Women's Clothing</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div className="">
          <div>
            <h2 className="text-3xl my-3">Electronics</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div className="">
          <div>
            <h2 className="text-3xl my-3">Misc</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
            {products
