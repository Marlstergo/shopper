  ...
  return (
    <>
      <div>
        <div>
          <div>
            <h2 className="text-3xl mb-6 font-semibold">{prodItem.title}</h2>
          </div>
          <div className="flex flex-col md:flex-row h-[400px]">
            ...
            <div className="md:w-1/2 flex flex-col items-start space-y-6  justify-center text-left">
              ...
              <button className="px-3 rounded-lg text-white py-2 bg-gray-700 hover:bg-gray-900">Add to cart</button>
            </div>
          </div>
        </div>
      </div>
