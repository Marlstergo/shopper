      ...
      <div className="min-h-[80vh] flex flex-col space-y-5">
        ...
        <div className="">
          <div>
            ...
            className="text-3xl my-3 font-semibold">Jewelery</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div className="">
          <div>
            ...
            className="text-3xl my-3 font-semibold">Women's Clothing</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div className="">
          <div>
            ...
            className="text-3xl my-3 font-semibold">Electronics</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div className="">
          <div>
            ...
            className="text-3xl my-3 font-semibold">Misc</h2>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
            {products
